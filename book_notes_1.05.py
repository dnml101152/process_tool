...
QListWidgetItem, QAbstractItemView, QCompleter, QShortcut,QMenu
)
...
class TagEditor(QWidget):
    ...
    def populate_tag_list(self):
        ...
        # Group tags by 'group', use 'Ungrouped' for missing ones
        grouped = {}
        ...
        # Sort group names and tag titles within each group
        for group_name in sorted(grouped):
            # Add non-selectable group header
            header_item = QListWidgetItem(f"Group: {group_name}")
            ...
            for title in sorted(grouped[group_name]):
